    ...
    public struct PointyHexagonGrid : IMeshGenerator {
        ...
        public void Execute<S> (int z, S streams) where S : struct, IMeshStreams {
            ...
            for (int x = 0; x < Resolution; x++, vi += 7, ti += 6) {
                ...
                streams.SetTriangle(ti + 0, vi + int3(2, 1, 0));
				streams.SetTriangle(ti + 1, vi + int3(3, 2, 0));
				streams.SetTriangle(ti + 2, vi + int3(4, 3, 0));
				streams.SetTriangle(ti + 3, vi + int3(5, 4, 0));
				streams.SetTriangle(ti + 4, vi + int3(6, 5, 0));
				streams.SetTriangle(ti + 5, vi + int3(1, 6, 0));
            }
